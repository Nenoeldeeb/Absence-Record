...
class ReportRepositoryImplTest {
    ...
    /**
     * Test implementation of DispatcherProvider that uses real dispatchers. For instrumentation
     * tests, we want real dispatcher behavior.
     */
    ...
    fun setUp() {
        ...
        repository = ReportRepositoryImpl(context, testDispatcherProvider)
    ...
    fun generateAndSaveReport_createsValidPngFile() =
        runTest {
            ...
            val attendance =
                listOf(LocalDate(2023, 10, 5), LocalDate(2023, 10, 15), LocalDate(2023, 10, 25))
